...
比如当 <https://www.harttle.com> 对应的 HTML 非常大而且网络很好时，
`onprogress` 事件处理器可能碰撞在同一个渲染帧中，或者干脆在同一个 Tick。
这样页面会长时间空白，即使 `onprogress` 早已被调用过。

> 关于异步渲染的阻塞行为，可参考 <https://www.harttle.com/2016/11/26/dynamic-dom-render-blocking.html>
...
[async-render]: https://www.harttle.com/2016/11/26/dynamic-dom-render-blocking.html
[css-js-render]: https://www.harttle.com/2016/11/26/static-dom-render-blocking.html
