...
1. 用 iOS UC 浏览器访问：<https://www.harttle.com/animation-bugs/a-normal-animation.html> ，你会看到一个旋转的动画。
2. 手势触发一下页面滚动，在手指未离开屏幕期间动画会被暂停。

这里有一个录屏： <https://www.harttle.com/animation-bugs/a-normal-animation-uiwebview.mp4>
