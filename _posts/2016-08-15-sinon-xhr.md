...
```javascript
it('should GET url: https://www.harttle.com', function() {
    var $.get('https://www.harttle.com');
    expect(xhr.url).to.equal('https://www.harttle.com');
...
describe('server', function(){
    before(function() {
        ...
        server.respondWith('GET', 'https://www.harttle.com', 
...
it('should respond with 200 harttleland', function() {
    reuturn $.get('https://www.harttle.com')
...
```javascript
expect($.get('https://www.harttle.com')).to.eventually.equal('harttleland');
```
