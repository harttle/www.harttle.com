...
var url = "https://www.harttle.com:80/tags.html?simple=true#HTML",
...
```
url:    https://www.harttle.com:80/tags.html?simple=true#HTML
scheme: http
slash:  //
host:   www.harttle.com
port:   80
path:   tags.html
query:  single=true
hash:   HTML
...
匹配结果是`www.harttle.com`，被存放到`fields[3]`中。
