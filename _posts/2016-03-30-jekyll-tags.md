...
我在 www.harttle.com 已经有219篇文章了，把它们标签拿出来不就是现成的标签库嘛！
...
恰好[我的博客][www.harttle.com]有一个`tags.json`：
...
它生成的页面就是一个JSON文件（也可以访问 <https://www.harttle.com/api/tags.json> 查看）：
...
[www.harttle.com]: https://www.harttle.com
